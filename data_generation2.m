function signalgen_module_all2()
    % This function reads config.json and sequentially runs signalgen_module for all location1.csv, location2.csv, ... in the specified directory.
        ...
        location_dir = config.location_seedfiles_path2;
        ...
        save_data_path = config.save_data_path2;
        save_logs_path = config.save_logs_path2;
        ...
        save_full_path = config.save_full_path2;
        ...
        location_seed_src = config.location_seedfiles_path2;
