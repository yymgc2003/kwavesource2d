...
save(fullfile(save_data_path, ['sandbox/air_lossy_vert_refined_true' num2str(ppw) '.mat']), 'p1', 'p2', 'kgrid', '-v7.3');
...
saveas(gcf, fullfile(save_pic_path, ['sandbox/experimental_setup_air_lossless_vert_true.png']));
...
xlim([0,t_end*1e6]);
saveas(gcf, fullfile(save_pic_path, ['sandbox/air_lossy_vert_refined_true' num2str(ppw) '.png']));