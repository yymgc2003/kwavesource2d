...
for ppw=2:1:20
    ...
    save(fullfile(save_data_path, ['sandbox/air_lossless1Dc' num2str(air.sound_speed) 'rho' num2str(round(air.density)) '_ppw' num2str(ppw) '.mat']), 'p1', 'p2', 'kgrid', '-v7.3');
    ...
    xlim([0,t_end*1e6]);
    saveas(gcf, fullfile(save_pic_path, ['sandbox/air_lossless1Dc' num2str(air.sound_speed) 'rho' num2str(round(air.density)) '_ppw' num2str(ppw) '.png']));
end