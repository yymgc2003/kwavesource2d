...
save(fullfile(save_data_path, ['sandbox/glass_nonlinear' num2str(Nx) '_cfl0.05.mat']), 'sensor_data', 'kgrid', '-v7.3');
...
xlim([0,t_end*1e6]);
saveas(gcf, fullfile(save_pic_path, ['sandbox/glass_nonlinear' num2str(Nx) '_cfl0.05.png']));