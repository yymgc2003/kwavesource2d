...
save(fullfile(save_data_path, ['sandbox/air_lossy' num2str(round(air.sound_speed)) '_' num2str(round(air.density)) '_cfl0.03.mat']), 'sensor_data', 'kgrid', '-v7.3');
...
saveas(gcf, fullfile(save_pic_path, ['sandbox/experimental_setup_air_lossy.png']));
...
xlim([0,t_end*1e6]);
saveas(gcf, fullfile(save_pic_path, ['sandbox/air_lossy' num2str(round(air.sound_speed)) '_' num2str(round(air.density)) '_cfl0.03.png']));